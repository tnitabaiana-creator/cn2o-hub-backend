...
const AGENTES = [
  ...
  { slug: 'qualificacao-imovel', nome: 'Qualificação do Imóvel', codigo_ato: null, ordem: 5, categoria: 'ferramenta',
    descricao: 'Matrícula e documentos fiscais entram — ou, para posse, o documento descritivo ou o próprio descritivo colado. Sai a qualificação em parágrafo único, a tabela de preenchimento do sistema, o comparativo de valores e os alertas. Não redige escritura.',
